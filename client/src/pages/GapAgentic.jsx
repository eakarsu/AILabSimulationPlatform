...
// Agentic
// Agentic lab assistant guiding students through procedural steps with adaptive difficulty
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic lab assistant guiding students through procedural steps with adaptive difficulty</p>
