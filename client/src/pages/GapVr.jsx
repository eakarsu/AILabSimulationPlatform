...
// Vr
// VR lab simulation integration for immersive STEM learning

export default function GapVr() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-vr', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Vr</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>VR lab simulation integration for immersive STEM learning</p>
