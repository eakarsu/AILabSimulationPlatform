...
// Streaming
// Streaming safety anomaly detection during virtual lab sessions
...
export default function GapStreaming() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Streaming safety anomaly detection during virtual lab sessions</p>
