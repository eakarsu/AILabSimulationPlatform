...
export default function GapLms() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-lms', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Lms</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>LMS integration (Canvas, Moodle)</p>
