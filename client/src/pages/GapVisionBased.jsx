...
// Vision Based
// Vision-based lab procedure verification (photograph setup, validate against expected configuration)
...
export default function GapVisionBased() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Vision-based lab procedure verification (photograph setup, validate against expected configuration)</p>
