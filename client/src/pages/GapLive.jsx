...
// Live
// Live chat / shared notebooks during labs (collaboration entity exists but no realtime layer)

export default function GapLive() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-live', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Live</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Live chat / shared notebooks during labs (collaboration entity exists but no realtime layer)</p>
