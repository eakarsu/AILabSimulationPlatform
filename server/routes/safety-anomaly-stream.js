...
// Domain: real-time lab safety monitor — Capability: detecting unsafe procedural steps in a virtual lab session
...
router.post('/run', async (req, res) => {
  try {
    ...
    const systemPrompt = 'You are a real-time lab safety monitor. Your task is detecting unsafe procedural steps in a virtual lab session. Respond with concise JSON: { "summary": string, "recommendations": string[], "next_actions": string[], "confidence": number }.';
